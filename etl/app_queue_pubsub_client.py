...
class PubSubClient:
    ...
    def __init__(self):
        ...
        self.topic_dlq = self.publisher_client.topic_path(
            self.settings.cloud.gcp_project_id,
            self.settings.cloud.pubsub_topic_dlq
        )
        
        # Subscription path
        self.subscription_path = self.subscriber_client.subscription_path(
            self.settings.cloud.gcp_project_id,
            self.settings.cloud.pubsub_subscription
        )
    ...
    def _verify_resources(self):
        ...
        try:
            ...
            logger.info(f"Topic {self.settings.cloud.pubsub_topic_submissions} verified")
        except exceptions.NotFound:
            logger.warning(f"Topic not found, creating: {self.settings.cloud.pubsub_topic_submissions}")
        ...
        try:
            ...
            logger.warning(f"DLQ Topic not found, creating: {self.settings.cloud.pubsub_topic_dlq}")
        ...
        try:
            ...
            logger.info(f"Subscription {self.settings.cloud.pubsub_subscription} verified")
        except exceptions.NotFound:
            logger.warning(f"Subscription not found, creating: {self.settings.cloud.pubsub_subscription}")
    ...
    def publish_submission(
        ...
        try:
            ...
            logger.info(
                f"Message published to main topic",
                request_id=request_id,
