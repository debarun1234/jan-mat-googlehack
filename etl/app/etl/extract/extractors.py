...
class BaseExtractor(ABC):
    ...
    @abstractmethod
    def extract(self, content: Any, request_id: str, **kwargs) -> Dict[str, Any]:
        """
...
class TextExtractor(BaseExtractor):
    ...
    def extract(self, content: str, request_id: str, **kwargs) -> Dict[str, Any]:
        """
...
class ImageExtractor(BaseExtractor):
    ...
    def extract(
        self, content: bytes, request_id: str, gcs_uri: Optional[str] = None, **kwargs
    ) -> Dict[str, Any]:
        """
...
class PDFExtractor(BaseExtractor):
    ...
    def extract(self, content: bytes, request_id: str, **kwargs) -> Dict[str, Any]:
        """
