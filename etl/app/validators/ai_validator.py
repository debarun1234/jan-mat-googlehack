...
class AIOutputValidator:
    ...
    def validate_category(self, category: str) -> bool:
        ...
        if category not in allowed_categories:
            raise AIValidationError(
                ...
                error_code=ErrorCode.AI_INVALID_RESPONSE,
                details={"provided": category, "allowed": list(allowed_categories)},
            )
    ...
    def validate_priority(self, priority: str) -> bool:
        ...
        if priority not in allowed_priorities:
            raise AIValidationError(
                ...
                error_code=ErrorCode.AI_INVALID_RESPONSE,
                details={"provided": priority, "allowed": list(allowed_priorities)},
            )
    ...
    def validate_sentiment(self, sentiment: str) -> bool:
        ...
        if sentiment not in allowed_sentiments:
            raise AIValidationError(
                ...
                error_code=ErrorCode.AI_INVALID_RESPONSE,
                details={"provided": sentiment, "allowed": list(allowed_sentiments)},
            )
    ...
    def validate_summary_en(self, summary: str) -> bool:
        ...
        if len(summary) < min_length:
            raise AIValidationError(
                ...
                error_code=ErrorCode.AI_INVALID_RESPONSE,
                details={"length": len(summary), "minimum": min_length},
            )
        ...
        if len(summary) > max_length:
            raise AIValidationError(
                ...
                error_code=ErrorCode.AI_INVALID_RESPONSE,
                details={"length": len(summary), "maximum": max_length},
            )
    ...
    def validate_semantic_plausibility(
        self, summary: str, original_text: str, confidence: float
    ) -> bool:
        """
    ...
    def validate_full_response(
        ...
        try:
            ...
            logger.debug(
                "✓ Structural validation passed", extra={"request_id": request_id}
            )
            ...
            if original_text:
                ...
                logger.debug(
                    "✓ Semantic check passed", extra={"request_id": request_id}
                )
